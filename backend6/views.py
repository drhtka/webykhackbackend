...
class Backend6View(View):
    ...
    def get(self, request):
        ...
        request.session['my_lists'] = my_array
...
class Backend6OutView(View):
    ...
    def post(self, request):
        ...
        my_test_ses = request.session['my_lists']
        #my_counter = 0
        my_return = ''
        if search_name != '':
            for my_test_ses_s in my_test_ses:
                if my_test_ses_s[1] == search_name:
                    ...
                    print(my_return)
                    request.session['my_lists'] = my_return

                    return render(request, 'backend6/backendout6.html', {'out_array': request.session['my_lists']})
                else:
